<template>
  <aside class="w-64 min-h-screen bg-gray-800 text-white flex flex-col py-8 px-4">
    ...
    <nav class="flex flex-col gap-2">
      ...
      <button
          ...
          @click="logout"
          class="flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-700 text-left w-full"
      >
